...
public:
    ...
    lab6::doubly_linked_list merge_sort(lab6::doubly_linked_list input, int iterations);
    lab6::doubly_linked_list quick_sort(lab6::doubly_linked_list input, int iterations);
};
