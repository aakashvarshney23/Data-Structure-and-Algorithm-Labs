...
lab6::doubly_linked_list sorts::merge_sort(lab6::doubly_linked_list input, int iterations) {
    return lab6::doubly_linked_list();
}

lab6::doubly_linked_list sorts::quick_sort(lab6::doubly_linked_list input, int iterations) {
    return lab6::doubly_linked_list();
}
