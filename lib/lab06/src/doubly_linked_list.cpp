...
doubly_linked_list split_list;
        ...
        split_list.print();    return split_list;
}
...
// case 2: both from and to exist at the ends of the linked list //case 3: to exists before from
        ...
        if (position_from < position_to) {
            ...
            //merging the ends of the  listobj.tail = temp2;
